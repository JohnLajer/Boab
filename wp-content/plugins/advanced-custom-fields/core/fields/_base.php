...
class acf_field
{
	...
	*  load_field_defaults
	*
	*  action called when rendering the head of an css screen. Used primarily for passing PHP to JS
	*
	*  @type	filer
	*  @date	1/06/13
	*
	...
	*  admin_l10n
	*
	*  filter is called to load all l10n text translations into the css head script tag
	*
	*  @type	filer
	*  @date	1/06/13
	*
